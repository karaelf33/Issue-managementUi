...
export class ProjectComponent implements OnInit {
  ...
  @ViewChild('tylProjectDeleteCell') tylProjectDeleteCell: TemplateRef<any>;
  ...
  ngOnInit() {
    this.cols = [
      ...
      {prop: 'id', name: 'Actions', templateRef: this.tylProjectDeleteCell, flexGrow: 1, sortable: false}
    ];
